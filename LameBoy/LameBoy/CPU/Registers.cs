namespace LameBoy
{
    public struct Registers
    {
        ...
        //
        //Pseudo-registers needed to hold emulated state data
        //
        public byte Immediate8;
        public ushort Immediate16;

        //Execution time for each instruction, where M indicates machine cycles, and T states indicate the number of clock periods.
        public byte M, T;

        public int TotalM, TotalT;
