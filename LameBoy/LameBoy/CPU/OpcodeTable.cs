...
/*0x20*/    new Opcode("JR NZ, ${0:X2}",  1, 8,    (ref Registers regs, Memory mem) => { if(regs.Z) return; if(regs.Immediate8 >= 128) regs.PC -= (ushort) (256 - regs.Immediate8); else regs.PC += regs.Immediate8; }),
            ...
            new Opcode("UNIMP JR 0x{0:X2}",     0, 12,   (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP ADD HL, DE",      0, 8,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, (DE)",      0, 8,    (ref Registers regs, Memory mem) => { /*TODO*/}),
...
/*0x30*/    new Opcode("UNIMP JR NC,r8",        1, 8,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD SP,0x{0:X4}",  2, 12,   (ref Registers regs, Memory mem) => { /*TODO*/}),
...
/*0x70*/    new Opcode("UNIMP LD (HL), B",      0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            ...
            new Opcode("UNIMP LD A, B",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, C",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, D",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, E",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, H",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, L",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, (HL)",      0, 8,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP LD A, A",         0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
/*0x80*/    new Opcode("UNIMP ADD A, B",        0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP ADD A, C",        0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
...
/*0xA0*/    new Opcode("UNIMP AND B",           0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            ...
            new Opcode("UNIMP AND A",           0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
...
/*0xB0*/    new Opcode("UNIMP OR B",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR C",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR D",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR E",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR H",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR L",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR (HL)",         0, 8,    (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP OR A",            0, 4,    (ref Registers regs, Memory mem) => { /*TODO*/}),
...
/*0xC0*/    new Opcode("UNIMP RET NZ",          0, 20,   (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP POP BC",          0, 12,   (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("UNIMP JP NZ, ${0:X4}",  0, 16,   (ref Registers regs, Memory mem) => { /*TODO*/}),
            new Opcode("JP ${0:X4}",      2, 16,   (ref Registers regs, Memory mem) => { regs.PC = regs.Immediate16; }),
            new Opcode("UNIMP CALL NZ, ${0:X4}",0, 24,   (ref Registers regs, Memory mem) => { /*TODO*/}),
